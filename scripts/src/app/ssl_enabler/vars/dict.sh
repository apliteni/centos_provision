...
DICT['en.errors.reinstall_keitaro']="Your server is not properly configured. Please contact Keitaro support team"
DICT['en.errors.reinstall_keitaro_ssl']="Nginx settings of your Keitaro installation does not properly configured. Please contact Keitaro support team"
...
DICT['ru.errors.reinstall_keitaro']="Keitaro отконфигурирована неправильно. Пожалуйста обратитесь в техническую поддержку Keitaro"
DICT['ru.errors.reinstall_keitaro_ssl']="Настройки Nginx вашей Keitaro отконфигурированы неправильно. Пожалуйста обратитесь в техническую поддержку Keitaro"
