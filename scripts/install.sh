...
declare -A REPLAY_ROLE_TAGS_SINCE=(
  ...
  ['install-clickhouse']='2.36.0'
  ['tune-clickhouse']='2.33.3'

  ['install-mariadb']='2.32.3'
  ['tune-mariadb']='2.34.11'
...
run_ansible_playbook(){
  ...
  local command
  command="${env} $(get_ansible_playbook_command) -vv -i ${INVENTORY_PATH} ${PLAYBOOK_DIRECTORY}/playbook.yml"
